...
class Szalloda:
    ...
    def elerhetoIdoszak(self, szobaszam: int, erkezes: float, tavozas: float):
...
class Porta:
    def __init__(self, szalloda: object = Szalloda):
        self.szallodaPorta()
    ...
    def szallodaPorta(self):
        ...
        while True:
            ...
            if valasz == "1":
                ...
                if not self.datumEllenorzes(erkezes):
                ...
                if not self.datumEllenorzes(tavozas):
                    print("Hibás dátum formátum!")
                    continue
